...
public class Profile extends AppCompatActivity {
    ...
    String lon, lat,apiKey = "AIzaSyDOkAefn9IuHnggD41CFMLdSm1bsmFTItk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference documentReference = fStore.collection("usersloc").document(userId);
                documentReference.set(luser).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode){
                case PLACE_PICKER_REQUEST:
                    ...
                    luser.put("Longitude", lon);
                    luser.put("Latitude", lat);
